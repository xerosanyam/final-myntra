        ...
        if True:
            ...
            if x is True:
                if messageProtocolEntity.getType() == "text":
                    ...
                    print "printing in putlist", inputList, len(inputList)
                    ...
                    if messageProtocolEntity.getMediaType() == "location":
                        ...
                        if self.status == "trending_location":
                            temp = hotinarea.getProducts(messageProtocolEntity.getLatitude(),
                            ...
                            complaint.complaintLodge(self.problem, messageProtocolEntity.getLatitude(),
                                                     messageProtocolEntity.getLongitude(), self.url, self.caption)
                            self.status = "continue"
                            print messageProtocolEntity.getLatitude(), messageProtocolEntity.getLongitude()
